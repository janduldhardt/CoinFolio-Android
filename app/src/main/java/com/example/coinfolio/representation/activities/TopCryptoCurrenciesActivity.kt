...
class TopCryptoCurrenciesActivity : Fragment() {
    ...
    override fun onCreateView(
        ...
        SharedPreferencesUtil.writeToSharedPreferences(activity, "walletId", "1234567890")
        ...
        viewModel.mAllCryptoCurrenciesDTO.observe(viewLifecycleOwner, coinListObserver)
